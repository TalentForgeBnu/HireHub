...
public class PropostaServlet extends HttpServlet {
	...
	private void recuperarProposta(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		Endereco enderecoEmp = new Endereco("rua", "bairro", "uma cidade", "Estado", "12982-213", (int) 123, "complemento", "via expressa");
		Endereco enderecoInst = new Endereco("rua2", "bairro2", "uma cidade2", "Estado2", "12982-523", (int) 321, "complemento2", "via expressa2");
		Papel papelEmp = new Papel("empresa");
		Papel papelInst = new Papel("Instituicao");
		Empresa empresa = new Empresa("1", enderecoEmp, papelEmp, "8002-8922", "sim@gmail", "12-2314-341", "millium", LocalDate.now(), "boa");
		Instituicao instituicao = new Instituicao("123", enderecoInst, papelInst, "840", "id@gmail.com", "cnpj", "cebrac", LocalDate.now(), "curso bom");
