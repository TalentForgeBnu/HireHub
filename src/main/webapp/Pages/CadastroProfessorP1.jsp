...
<body>
    ...
    <div class="container">
        ...
        <div class="right-section">
            ...
            <form action="CadastroProfessorP2.jsp" method="post">
                ...
                <div>
                    <input type="checkbox" name="termos" required> Li e concordo com os <a href="#">termos de uso</a>.
                </div>
                <div class="form-actions">
                    <button type="button" class="cancel">Cancelar</button>
                    <button type="submit" class="next" id="nextBtn" onclick="desabilitarBotao()">Próximo</button>
                </div>
            </form>
    ...
    <script>
        function desabilitarBotao() {
            var botao = document.getElementById('nextBtn');
